                    ...
                    <div class="cpt-price">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <span><?= get_field('etiqueta_de_precio'); ?> X</span>
                                <input type="hidden" name="" value="<?= get_field('precio'); ?>" id="price">
                                <input class="input-cant" type="number" name="" value="<?= get_field('cantidad'); ?>" id="cant">
                            </div>
                        </div>
                        ...
                        <div class="total-price">
                            <span>Total (USD)</span>
                            <input class="total" type="text" name="" value="" id="total" disabled>
                        </div>
                    </div>
                    <!-- Precio -->
